...
import {Container, Grid , Typography , Box , Button , SvgIcon} from "@mui/material";
    ...
    return (
        ...
        <Grid item xs={8.5} sx={{
          ...
          تهران
            ...
            <Grid item xs={3.5}>
            <Typography variant="h6" component="h3" fontWeight="bold" marginY={1}  sx={{
              fontSize: "14px",
              color: "#4156d9",
              display: "flex",
              alignItems: "center",
            ...
            <SvgIcon
              ...
              sx={{ fontSize: 20, marginLeft: 2, transform: "rotate(90deg)" }}
            />
            </Typography>  
        </Grid>
        </Grid>
